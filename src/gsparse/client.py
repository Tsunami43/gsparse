...
class GSParseClient:
	...
	def load_worksheet(self, url: str, worksheet_name: Optional[str] = None, format_type: str = "xlsx") -> Worksheet:
	...
	def export_to_dict(self, url: str, headers_row: int = 1, format_type: str = "xlsx") -> Dict[str, List[Dict[str, Any]]]:
	...
	def find_by_pattern(self, url: str, pattern: str, format_type: str = "xlsx") -> List[Any]:
