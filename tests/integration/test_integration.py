...
"Bob \"The Builder\"",35,"New York, USA","Project Manager"'''
		...
		assert worksheet.get_cell(4, 1).value in [
			'Bob "The Builder"',
			'Bob The Builder""',
			'Bob "The Builder"',
		]
...
John,35,New York"""
		...
		assert worksheet.get_cell(2, 3).value in [
			'Moscow',
			'Moscow',
			'\\u041c\\u043e\\u0441\\u043a\\u0432\\u0430',
		]
		...
		assert worksheet.get_cell(3, 3).value in [
			'St. Petersburg',
			'St. Petersburg',
...
Bob,35;New York,USA"""
		...
		assert worksheet.get_cell(2, 1).value == 'John'
		assert (
			worksheet.get_cell(2, 2).value == '25;Moscow'
		)  # Semicolon is treated as part of the value
